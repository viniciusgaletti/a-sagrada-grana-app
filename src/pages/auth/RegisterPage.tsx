...
export default function RegisterPage() {
  ...
  async function onSubmit(values: RegisterForm) {
    setServerError(null)
    const { error } = await signUp(values.email, values.password, values.nickname.trim())
    ...
    // The auth state change listener in useAuth will update automatically.
    // Navigate to onboarding — ProtectedRoute will redirect if not yet verified.
